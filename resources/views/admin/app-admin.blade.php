...
<header class="main-header">
    ...
    <a href="/" target="_blank" class="logo">
      ...
      <span class="logo-lg"><b>Bengal</b>Nest</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="/admin-layout/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="/admin-layout/img/user2-160x160.jpg" class="user-image" alt="User Image">
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    Your Application's Landing Page - Admin Page. From ashraf and we will use a Admin Panel Here
                </div>
            </div>
        </div>
    </div>
